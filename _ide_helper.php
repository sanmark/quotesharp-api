...
namespace Sanmark\PhpHelpers{
    ...
    class ArrayHelper extends \Sanmark\PhpHelpers\Facades\ArrayHelperFacade{
        ...
        public static function getValueIfKeyExistsOrNull($array, $key){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::getValueIfKeyExistsOrNull($array, $key);
        }
        ...
        public static function getValuesIfKeysExist($values, $keys){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::getValuesIfKeysExist($values, $keys);
        }
        ...
        public static function pruneEmptyElements($array){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::pruneEmptyElements($array);
        }
        ...
        public static function AddSameKeyElements($firstArray, $secondArray){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::AddSameKeyElements($firstArray, $secondArray);
        }
        ...
        public static function areAllElementsEmpty($array){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::areAllElementsEmpty($array);
        }
        ...
        public static function areAllElementsFilled($array){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::areAllElementsFilled($array);
        }
         ...
         * @static 
         */
        public static function hasAtLeastOneElementWithValue($array, $except = null){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::hasAtLeastOneElementWithValue($array, $except);
        }
         ...
         * @static 
         */
        public static function without($array, $excepts){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::without($array, $excepts);
        }
         ...
         * @static 
         */
        public static function withoutRecursive($array, $excepts){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::withoutRecursive($array, $excepts);
        }
         ...
         * @static 
         */
        public static function hasAtLeastOneElementWithValueInAtLeastOneChildArrayRecursive($array){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::hasAtLeastOneElementWithValueInAtLeastOneChildArrayRecursive($array);
        }
        ...
        public static function areAllElementsHasValue($array){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::areAllElementsHasValue($array);
        }
        ...
        public static function removeWhiteSpacesInValuesRecursive($array){
            return \Sanmark\PhpHelpers\Classes\ArrayHelper::removeWhiteSpacesInValuesRecursive($array);
        }
        
    }


    class BooleanHelper extends \Sanmark\PhpHelpers\Facades\BooleanHelperFacade{
        ...
        public static function getTrueFalseOrNull($value){
            return \Sanmark\PhpHelpers\Classes\BooleanHelper::getTrueFalseOrNull($value);
        }
        
    }


    class DateTimeHelper extends \Sanmark\PhpHelpers\Facades\DateTimeHelperFacade{
        ...
        public static function convertTextToFormattedDateTime($text, $format = 'Y-m-d H:i:s'){
            return \Sanmark\PhpHelpers\Classes\DateTimeHelper::convertTextToFormattedDateTime($text, $format);
        }
        ...
        public static function dateTimeRefill($dateTimeForFormat){
            return \Sanmark\PhpHelpers\Classes\DateTimeHelper::dateTimeRefill($dateTimeForFormat);
        }
        ...
        public static function dateRefill($dateTimeForFormat){
            return \Sanmark\PhpHelpers\Classes\DateTimeHelper::dateRefill($dateTimeForFormat);
        }
        ...
        public static function dateDifferenceUntilToday($date){
            return \Sanmark\PhpHelpers\Classes\DateTimeHelper::dateDifferenceUntilToday($date);
        }
        
    }


    class NullHelper extends \Sanmark\PhpHelpers\Facades\NullHelperFacade{
        ...
        public static function zeroIfNull($value){
            return \Sanmark\PhpHelpers\Classes\NullHelper::zeroIfNull($value);
        }
        ...
        public static function zeroIfEmptyString($string){
            return \Sanmark\PhpHelpers\Classes\NullHelper::zeroIfEmptyString($string);
        }
        ...
        public static function isNullEmptyOrWhitespace($value){
            return \Sanmark\PhpHelpers\Classes\NullHelper::isNullEmptyOrWhitespace($value);
        }
        ...
        public static function nullIfEmpty($value){
            return \Sanmark\PhpHelpers\Classes\NullHelper::nullIfEmpty($value);
        }
        ...
        public static function ifNullEmptyOrWhitespace($valueOne, $valueTwo){
            return \Sanmark\PhpHelpers\Classes\NullHelper::ifNullEmptyOrWhitespace($valueOne, $valueTwo);
        }
        
    }


    class NumberHelper extends \Sanmark\PhpHelpers\Facades\NumberHelperFacade{
        ...
        public static function getMinimumAvailableNumberFromArray($array){
            return \Sanmark\PhpHelpers\Classes\NumberHelper::getMinimumAvailableNumberFromArray($array);
        }
        
    }


    class ObjectHelper extends \Sanmark\PhpHelpers\Facades\ObjectHelperFacade{
        ...
        public static function nullIfNonObject($object, $property){
            return \Sanmark\PhpHelpers\Classes\ObjectHelper::nullIfNonObject($object, $property);
        }
        
    }


    class StringHelper extends \Sanmark\PhpHelpers\Facades\StringHelperFacade{
        ...
        public static function removeWhiteSpaces($string){
            return \Sanmark\PhpHelpers\Classes\StringHelper::removeWhiteSpaces($string);
        }
